...
<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">Kata Sambutan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Informasi Jurusan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Syarat dan Biaya</a>
            </li>
        </ul>
        <!-- Akhir dari menu menyamping -->
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#"
                ...
                <div class="d-sm-none d-lg-inline-block">Hi, Mahasiswa Baru</div>
            </a>
